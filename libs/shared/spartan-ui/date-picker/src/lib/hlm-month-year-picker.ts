...
export class HlmMonthYearPicker<T> implements BrnDatePickerBase<T>, ControlValueAccessor {
	...
	*/
	...
	public updateDate(value: T | null) {
		if (this._disabled()) return;
		const transformedDate = value == undefined ? undefined : this.transformDate()(value);
	...
	*/
	...
	public registerOnChange(function_: ChangeFn<T | null>): void {
		this._onChange = function_;
	}

	public registerOnTouched(function_: TouchFn): void {
