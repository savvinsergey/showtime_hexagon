...
import { HlmNumberedPaginationQueryParams as HlmNumberedPaginationQueryParameters } from './lib/hlm-numbered-pagination-query-params';
...
export const HlmPaginationImports = [
	...
	HlmNumberedPaginationQueryParameters,
] as const;
